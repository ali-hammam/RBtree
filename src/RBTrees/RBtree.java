...
//            System.out.println("RED PARENT RED UNCLE :: " + node + " :: " + parentNode + " :: " + uncleNode);
    ...
    private void chooseRotation(Node node){
        ...
        if (grandParent != null ){
            if(grandParent.left == parent) {
                if(parent.left == node){
//                    System.out.println("LEFT LEFT :: " + node + " :: " + parent + " :: " + grandParent);
                    this.leftLeftCase(node);
                    this.format(node.right);
                }else if (parent.right == node) {
//                    System.out.println("LEFT RIGHT :: " + node + " :: " + parent + " :: " + grandParent);
                    this.leftRightCase(node);
                    this.format(node.right);
                }
            }else if(grandParent.right == parent) {
                if (parent.left == node) {
//                    System.out.println("RIGHT LEFT :: " + node + " :: " + parent + " :: " + grandParent);
                    this.rightLeftCase(node);
                    this.format(node.left);
                } else if (parent.right == node) {
//                    System.out.println("RIGHT RIGHT :: " + node + " :: " + parent + " :: " + grandParent);
    ...
    public void leftLeftCase(Node node){
        /*
            1- if grand parent == null
                a- return leftLeftCaseWhenParentIsRoot
            2- check grand parent != null
                a- grandParent.left = parent.right
                b- grandParent.left.parent = grandParent
                c- parent.right = grandParent
                d- parent.parent = grandParent.parent
